...
const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
      ...
      <div
        className={`relative w-full max-w-md rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 ${
          isDark
          ...
          <section className="space-y-4">
            ...
            >
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl font-bold text-sm transition-all ${
                  isDark
                    ? "bg-slate-800 shadow-lg text-blue-400"
          ...
          <section className="space-y-4">
            ...
            >
              <button
                ...
                className={`flex-1 flex items-center justify-center py-2 rounded-xl font-bold text-sm transition-all ${
